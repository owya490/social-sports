---
version: 1
slug: "frontend-components-organiser-organisersidebar-tsx"
primary_target: "frontend/components/organiser/OrganiserSidebar.tsx"
related_targets: ["frontend/components/organiser/OrganiserShell.tsx"]
---
...
| SPORTSHUB logo | Existing `BlackLogo.svg` (identity only — not an exit) |
...
| Back to SPORTSHUB | Footer cluster under Settings — muted text (expanded) / `HomeIcon` (collapsed); not in brand band |

## Unresolved
None for this pass — desktop collapse/expand stays as-is. Exit hatch lives in the sidebar footer.
