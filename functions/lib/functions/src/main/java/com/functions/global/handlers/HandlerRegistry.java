...
import com.functions.stripe.handlers.CreateStripeStandardAccountHandler;
...
public class HandlerRegistry {
    ...
    static {
        ...
        handlers.put(EndpointType.CREATE_STRIPE_STANDARD_ACCOUNT, new CreateStripeStandardAccountHandler());
