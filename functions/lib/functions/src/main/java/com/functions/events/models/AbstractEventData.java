...
public abstract class AbstractEventData {
	...
	/**
	 * Per-type pricing and vacancy. Purchase flows resolve a ticket type (defaulting
	 * to General); top-level price/capacity/vacancy are co-updated with the General type.
	 */
	@Nullable
