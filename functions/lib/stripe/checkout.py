...
def create_stripe_checkout_session_by_event_id(transaction: Transaction, logger: Logger, event_id: str, quantity: int, is_private: bool, cancel_url: str, success_url: str):
  ...
  RAPTOR_BSOC_EVENT_IDS = ["mcixD9jhIMR8Lh8UiEax", "SmAsmIOSINbolcKgc0Rb", "sBND4zc3xh7U2J60SOsr", "BGET5N7z9wu15cAJtIKL"]
...
@https_fn.on_call(cors=options.CorsOptions(cors_origins=["https://www.sportshub.net.au", "*"], cors_methods=["head", "post"]), region="australia-southeast1")
