...
from lib.sendgrid.constants import DELETE_EVENT_ORGANISER_EMAIL_TEMPLATE_ID, SENDGRID_API_KEY
...
def send_email_on_delete_event_for_organiser(req: https_fn.CallableRequest):
    ...
    try:
        ...
        for purchaser_id, purchaser_info in purchaser_map.items():
            ...
            message.template_id = DELETE_EVENT_ORGANISER_EMAIL_TEMPLATE_ID
