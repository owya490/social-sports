...
Events start with a single **General Admission** ticket type from the price and capacity you set. After creation, you can add more [ticket types](/docs/organisers/events/ticket-types) from Organiser Hub **Settings**.
