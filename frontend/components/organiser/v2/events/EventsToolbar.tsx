  ...
  const filtersButton =
    showFilters && onToggleFilters ? (
      <button
        ...
        className={`inline-flex shrink-0 items-center gap-2 rounded-xl border px-3 py-2.5 text-sm font-medium font-sans transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus ${
          filtersOpen
