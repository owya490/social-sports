...
import OrganiserMobileNavbar from "./mobile/OrganiserMobileNavbar";
...
export default function OrganiserNavbar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden sm:block bg-white border-r-[1px] border-core-outline fixed bottom-0 sm:bottom-auto inset-x-0 sm:inset-x-auto sm:left-0 sm:h-screen z-40">
