    ...
    >
      ...
      >
        <NavButton
          ...
          isActive={currPage.startsWith("/organiser/v2/dashboard") || currPage.startsWith("/organiser/dashboard")}
        ...
        <NavButton
          ...
          isActive={currPage === "/organiser/v2/gallery" || currPage === "/organiser/gallery"}
