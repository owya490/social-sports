...
export default function Footer() {
  return (
    <footer id="footer" className="bg-white lg:grid lg:grid-cols-5 bottom-0 w-full pb-10 lg:pb-0">
      ...
      <div className="px-4 py-8 md:py-16 sm:px-6 lg:col-span-3 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-100 pt-12">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <p className="mt-8 text-xs text-gray-500 sm:mt-0">&copy; 2023. Sports Up. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
