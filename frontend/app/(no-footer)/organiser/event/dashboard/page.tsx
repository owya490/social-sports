      ...
      <div className="flex justify-center">
        <div className="flex flex-col items-start">
          ...
          <div className="flex flex-row h-full w-full overflow-hidden">
            ...
            />
            <div className="z-5 grid grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-4 gap-x-2 2xl:gap-x-5 gap-y-2 2xl:gap-y-5 justify-items-center max-h-screen overflow-y-auto px-4 min-w-[640px] 2xl:min-w-[1032px] 3xl:min-w-[1372px] h-[85vh]">
              {eventDataList
                .sort((event1, event2) => {
